document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form validation (both login and registration forms)
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(event) {
            ...
            if (!passwordRegex.test(password)) {
                alert('Password must be at least 10 characters long and include one special character, one uppercase letter, and one numeric digit.');
                isValid = false;
            }
    ...
    if (registrationForm) {
        registrationForm.addEventListener('submit', function(event) {
            ...
            if (!firstName || !lastName || !email || !mobileNumber || !city || !doctorId || !doctorName || !address || !contactNo || !gender) {
            ...
            if (!isValid) {
                ...
                alert(`Patient detail is registered successfully. Welcome, ${firstName}!`);
            }
        });
    }
